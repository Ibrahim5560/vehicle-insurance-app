...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vehicle-license-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLELICENSETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VEHICLELICENSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VEHICLELICENSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VEHICLELICENSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLELICENSETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VEHICLELICENSETYPE actions', async () => {
      const expectedActions = [
        {
