  ...
  return (
    <div>
      <h2 id="vehicle-license-type-heading" data-cy="VehicleLicenseTypeHeading">
        <Translate contentKey="vehicleInsuranceApp.vehicleLicenseType.home.title">Vehicle License Types</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="vehicleInsuranceApp.vehicleLicenseType.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="vehicleInsuranceApp.vehicleLicenseType.home.createLabel">Create new Vehicle License Type</Translate>
          </Link>
        </div>
      </h2>
        ...
        {vehicleLicenseTypeList && vehicleLicenseTypeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="vehicleInsuranceApp.vehicleLicenseType.id">ID</Translate>{' '}
                ...
                <th className="hand" onClick={sort('engName')}>
                  ...
                  <FontAwesomeIcon icon={getSortIconByFieldName('engName')} />
                </th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/vehicle-license-type/${vehicleLicenseType.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="vehicleInsuranceApp.vehicleLicenseType.home.notFound">No Vehicle License Types found</Translate>
            </div>
          )
        )}
      </div>
